...
def generate_json(filename: str):
    result = subprocess.run(['pdfannots', '-f', 'json', '{}'.format(filename)], stdout=subprocess.PIPE, cwd=os.getcwd())
    obj = json.loads(result.stdout)
    return obj

obj = generate_json("example.pdf")
